...
namespace util {
    ...
    /// unicode code points
    ///
    BOOST_LOCALE_DECL std::shared_ptr<base_converter> create_utf8_converter();
    ///
    ...
    ///
    BOOST_LOCALE_DECL std::shared_ptr<base_converter> create_simple_converter(std::string const &encoding);
